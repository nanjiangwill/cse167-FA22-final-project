...
void RTObj::init(const char *filename)
{
    ...
    for (size_t i = 0; i < n; i += 3)
    {
        ...
        triangle.P.push_back(glm::vec3(vertices[indices[i]][0], vertices[indices[i]][1], vertices[indices[i]][2]));
        triangle.P.push_back(glm::vec3(vertices[indices[i + 1]][0], vertices[indices[i + 1]][1], vertices[indices[i + 1]][2]));
        triangle.P.push_back(glm::vec3(vertices[indices[i + 2]][0], vertices[indices[i + 2]][1], vertices[indices[i + 2]][2]));
