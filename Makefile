...
RM = /bin/rm -f
all: SceneViewer
SceneViewer: main.o Shader.o Camera.o Obj.o RTObj.o Scene.o RTScene.o shaders/lighting.frag shaders/projective.vert
	$(CC) -o SceneViewer main.o Shader.o Camera.o Obj.o RTObj.o Scene.o RTScene.o $(LDFLAGS)
